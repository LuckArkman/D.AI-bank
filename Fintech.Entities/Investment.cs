...
public class Investment
{
    ...
    public Investment(Guid accountId, string name, InvestmentType type, decimal principalAmount, decimal expectedReturnRate)
    {
        Id = Guid.NewGuid();
        AccountId = accountId;
        Name = name;
...
public class SavingsGoal
{
    ...
    public SavingsGoal(Guid accountId, string name, decimal targetAmount, string color)
    {
        Id = Guid.NewGuid();
        AccountId = accountId;
        Name = name;
